...
<link rel="stylesheet" href="<%=request.getContextPath() %>/resources/css/side.css">
...
<!-- datePicker -->
<link href="<%=request.getContextPath() %>/resources/dist/css/datepicker.min.css" rel="stylesheet">
